    ...
    <div className='container mx-auto px-10'>
      <div className='flex lg:space-x-8 space-y-8 lg:space-y-0 flex-wrap lg:flex-nowrap '>
        <div className=' relative lg:w-1/2 w-full flex justify-center xl:justify-end py-4 px-9'>
          ...
          <div className='bg-dark absolute pb-4 -rotate-[7deg] xl:right-36 rounded-2xl md:w-[20.731rem] md:h-[41.828rem] shadow-2xl shadow-blue-800/40'>
            {/* profile */}
            <div>
              ...
              <div className='bg-dark flex items-center py-3 px-6 space-x-3'>
            ...
            <div className='space-y-10 px-4 py-10'>
              ...
              <div className=''>
                {/* top */}
                <div className='bg-white opacity-20 rounded-lg w-56 h-16 rounded-tl-none p-4 space-y-2'>
                  <div className='bg-gray-400 w-48 h-3 rounded'></div>
              ...
              <div className=''>
                {/* top */}
                <div className='bg-white opacity-20 rounded-lg w-56 h-18 rounded-tl-none p-4 space-y-2'>
                  <div className='bg-gray-400 w-48 h-3 rounded'></div>
                  <div className='bg-gray-400 w-40 h-3 rounded'></div>
            ...
            <div className='px-4'>
              {/* Tempat Ngetik */}
              <div className=' flex items-center px-5 py-3 bg-white opacity-20 rounded-full text-darkLight space-x-3 mt-12'>
                <AiOutlineSmile />
          ...
          <div className='bg-white xl:ml-48 pb-4 lg:ml-16 mt-12 rotate-[7deg] rounded-2xl md:w-[20.731rem] md:h-[41.828rem] shadow-2xl shadow-blue-800/40'>
            {/* profile */}
            <div>
              <div className='flex justify-center space-x-1 items-center py-4'>
                <div className='bg-gray-100 rounded w-12 h-1.5'></div>
            ...
            <div className='px-4'>
              {/* Tempat Ngetik */}
              <div className=' flex items-center px-5 py-3 border border-gray-300 rounded-full text-darkLight space-x-3 mt-12'>
                <AiOutlineSmile />
